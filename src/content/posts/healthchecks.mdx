...
Does your backend service have a robust healthcheck? Don't know what a healthcheck is? Unsure how to create a robust healthcheck?
...
1. The endpoint should be protected. This is important to:
    - Protect against DOS attacks by dropping connection ASAP.
